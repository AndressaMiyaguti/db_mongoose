...
const jwtf = () => {
  ...
  userProperty: "user", //Propriedade do usuário, objeto de configuração para identificar de qual camada será autorizado a visualização do usuário ex: aplicações com mais de uma area restrita
